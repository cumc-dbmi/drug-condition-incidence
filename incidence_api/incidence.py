...
from db import drug_condition, drug_list, condition_list, incidence_rate, incidence_rate_source_details, drug_list_brand
...
@app.route("/drug_list_brand", methods=['GET'])
def drug_list_brand_endpoint():
    results = drug_list_brand()
    response_body = json.dumps(results, default=serialize_obj)
    return Response(response_body, mimetype=APPLICATION_JSON_CONTENT_TYPE)
